...
bool ImGui::ContentTab(const char* label, bool active, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
	...
	// Render
	const ImVec4 text_dis = ImVec4(254.0231f / 255.f, 254.0231f / 255.f, 254.0231f / 255.f, 1.f);
	//const ImVec4 text_act = ImVec4(126 / 255.f, 131 / 255.f, 219 / 255.f, 1.f);
	const ImVec4 text_act = ImVec4(163 / 255.f, 163 / 255.f, 163.245f / 255.f, 1.f);
	...
	if (hovered || active)
		...
		//ImVec4 to = ;
		it_text->second = active ? text_act : text_hov;
	/*if (it_text->second.x != to.x)
	{
		if (it_text->second.x < to.x)
			it_text->second.x = ImMin(it_text->second.x + deltatime * 0.2f, to.x);
	...
	{
		if (it_text->second.y < to.y)
			it_text->second.y = ImMin(it_text->second.y + deltatime * 0.2f, to.y);
	...
	{
		if (it_text->second.z < to.z)
			it_text->second.z = ImMin(it_text->second.z + deltatime * 0.2f, to.z);
...
bool ImGui::MainTab(const char* label, ImFont* icon_font, const char* icon, bool active, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
	...
	// Render
	const ImVec4 text_dis = ImVec4(254.0231f / 255.f, 254.0231f / 255.f, 254.0231f / 255.f, 1.f);
	const ImVec4 text_act = ImVec4(136.00f / 255.f, 136.00f / 255.f, 136.00f / 255.f, 1.f);

	const ImVec4 icon_dis = ImVec4(254.0231f / 255.f, 254.0231f / 255.f, 254.0231f / 255.f, 1.f);
	const ImVec4 icon_act = ImVec4(136.00f / 255.f, 136.00f / 255.f, 136.00f / 255.f, 1.f);
	...
	if (active)
		it_icon->second = icon_act;
	else
		it_icon->second = icon_dis;
	...
	PushStyleColor(ImGuiCol_Text, it_text->second);
	if (!strcmp(label, crypt_str("Rage"))) {
		RenderTextClipped(bb.Min + ImVec2(size_arg.x * 0.36f, (4 * c_menu::get().dpi_scale) - 4 - 3), bb.Max, label, NULL, &label_size, ImVec2(0.f, 0.41f), &bb);
		draw->AddRectFilled(bb.Min + ImVec2(size_arg.x * 0.34f - 2, 4 * c_menu::get().dpi_scale - 4 + 2), bb.Min + ImVec2(size_arg.x * 0.34f - 1, 4 * c_menu::get().dpi_scale - 4 + 20), ImGui::ColorConvertFloat4ToU32(ImVec4(it_text->second)));
	}
	if (!strcmp(label, crypt_str("Legit"))) {
		RenderTextClipped(bb.Min + ImVec2(size_arg.x * 0.37f, (4 * c_menu::get().dpi_scale) - 4 - 3), bb.Max, label, NULL, &label_size, ImVec2(0.f, 0.41f), &bb);
		draw->AddRectFilled(bb.Min + ImVec2(size_arg.x * 0.34f - 1, 4 * c_menu::get().dpi_scale - 4 + 2), bb.Min + ImVec2(size_arg.x * 0.34f, 4 * c_menu::get().dpi_scale - 4 + 20), ImGui::ColorConvertFloat4ToU32(ImVec4(it_text->second)));
	}
	if (!strcmp(label, crypt_str("Visuals"))) {
		RenderTextClipped(bb.Min + ImVec2(size_arg.x * 0.37f, (4 * c_menu::get().dpi_scale) - 4 - 3), bb.Max, label, NULL, &label_size, ImVec2(0.f, 0.41f), &bb);
		draw->AddRectFilled(bb.Min + ImVec2(size_arg.x * 0.34f - 1, 4 * c_menu::get().dpi_scale - 4 + 2), bb.Min + ImVec2(size_arg.x * 0.34f, 4 * c_menu::get().dpi_scale - 4 + 20), ImGui::ColorConvertFloat4ToU32(ImVec4(it_text->second)));
	}
	if (!strcmp(label, crypt_str("Players"))) {
		RenderTextClipped(bb.Min + ImVec2(size_arg.x * 0.37f, (4 * c_menu::get().dpi_scale) - 4 - 3), bb.Max, label, NULL, &label_size, ImVec2(0.f, 0.41f), &bb);
		draw->AddRectFilled(bb.Min + ImVec2(size_arg.x * 0.34f - 1, 4 * c_menu::get().dpi_scale - 4 + 2), bb.Min + ImVec2(size_arg.x * 0.34f, 4 * c_menu::get().dpi_scale - 4 + 20), ImGui::ColorConvertFloat4ToU32(ImVec4(it_text->second)));
	}
	if (!strcmp(label, crypt_str("Misc"))) {
		RenderTextClipped(bb.Min + ImVec2(size_arg.x * 0.40f, (4 * c_menu::get().dpi_scale) - 4 - 3), bb.Max, label, NULL, &label_size, ImVec2(0.f, 0.41f), &bb);
		draw->AddRectFilled(bb.Min + ImVec2(size_arg.x * 0.34f + 1, 4 * c_menu::get().dpi_scale - 4 + 2), bb.Min + ImVec2(size_arg.x * 0.34f + 2, 4 * c_menu::get().dpi_scale - 4 + 20), ImGui::ColorConvertFloat4ToU32(ImVec4(it_text->second)));
	}
	if (!strcmp(label, crypt_str("Settings"))) {
		RenderTextClipped(bb.Min + ImVec2(size_arg.x * 0.36f, (4 * c_menu::get().dpi_scale) - 4 - 3), bb.Max, label, NULL, &label_size, ImVec2(0.f, 0.41f), &bb);
		draw->AddRectFilled(bb.Min + ImVec2(size_arg.x * 0.34f - 2, 4 * c_menu::get().dpi_scale - 4 + 2), bb.Min + ImVec2(size_arg.x * 0.34f - 1, 4 * c_menu::get().dpi_scale - 4 + 20), ImGui::ColorConvertFloat4ToU32(ImVec4(it_text->second)));
	}
	if (!strcmp(label, crypt_str("Scripts"))) {
		RenderTextClipped(bb.Min + ImVec2(size_arg.x * 0.40f, (4 * c_menu::get().dpi_scale) - 4 - 3), bb.Max, label, NULL, &label_size, ImVec2(0.f, 0.41f), &bb);
		draw->AddRectFilled(bb.Min + ImVec2(size_arg.x * 0.34f + 1, 4 * c_menu::get().dpi_scale - 4 + 2), bb.Min + ImVec2(size_arg.x * 0.34f + 2, 4 * c_menu::get().dpi_scale - 4 + 20), ImGui::ColorConvertFloat4ToU32(ImVec4(it_text->second)));
	}
	PopStyleColor();
...
bool ImGui::KeybindButton(const char* label, const char* unique_id, const ImVec2& size_arg, bool clicked, ImGuiButtonFlags flags)
{
	...
	RenderFrame(bb.Min, bb.Max, col, true, 100.f * c_menu::get().dpi_scale);
	ImGui::GetWindowDrawList()->AddRect(bb.Min, bb.Max, GetColorU32(ImVec4(126 / 255.f, 131 / 255.f, 219 / 255.f, it_hover->second)), 100.f * c_menu::get().dpi_scale);
...
std::map<ImGuiID, float> button_alpha;
...
bool ImGui::ButtonEx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
	...
	if (window->SkipItems)
		return false;
	static std::map<const char*, button_animation> circle_animation;
	...
	auto it_circle = circle_animation.find(label);

	if (it_circle == circle_animation.end())
	{
		circle_animation.insert({ label, {0.4f, 0.f, false, ImVec2(0, 0), false} });
		it_circle = circle_animation.find(label);
	}


	if (ImGui::IsItemClicked() || it_circle->second.active)
	{
		...
		it_circle->second.radius = std::clamp(it_circle->second.radius + (320.f * ImGui::GetIO().DeltaTime), 0.0f, 600.f);
	...
	ImU32 text_col = GetColorU32(ImVec4(1.f, 1.f, 1.f, *alpha));;

	// Render
	RenderFrame(bb.Min, bb.Max, ImColor(29, 29, 29, 255), true, 2.f);
	window->DrawList->AddRect(bb.Min, bb.Max, GetColorU32(ImVec4(0.35f, 0.35f, 0.35f, 100 / 255.f)), 2.f);
	window->DrawList->AddRect(bb.Min, bb.Max, GetColorU32(ImVec4(0 / 255.f, 128 / 255.f, 0.f, *alpha)), 2.f);

	window->DrawList->PushClipRect(bb.Min, bb.Max, false);
	window->DrawList->AddCircleFilled(it_circle->second.pos, it_circle->second.radius, ImColor(0 / 255.f, 128 / 255.f, 0.f, it_circle->second.alpha), 60);
	window->DrawList->PopClipRect();

	PushStyleColor(ImGuiCol_Text, ImVec4(0.8f, 0.8f, 0.8f, 1.f));
	RenderTextClipped(bb.Min + style.FramePadding, bb.Max - style.FramePadding, label, NULL, &label_size, style.ButtonTextAlign, &bb);
	PopStyleColor();
...
bool ImGui::ScrollbarEx(const ImRect& bb_frame, ImGuiID id, ImGuiAxis axis, float* p_scroll_v, float size_avail_v, float size_contents_v, ImDrawCornerFlags rounding_corners)
{
	...
	// Render
	ImVec4 hover_act = ImVec4(254.0231f / 255.f, 254.0231f / 255.f, 254.0231f / 255.f, 1.f);
	ImVec4 hover_dis = ImVec4(163 / 255.f, 163 / 255.f, 163.245f / 255.f, 1.f);
	...
	if (!hovered && !held)
		it_hcolor->second = hover_dis;
	else
		it_hcolor->second = hover_act;
...
std::map<ImGuiID, float> check_alpha, hover_alpha;
...
bool ImGui::Checkbox(const char* label, bool* v)
{
	...
	float* alpha = &check_alpha[id];
	float* hover_a = &hover_alpha[id];
	...
	if (*hover_a >= GetStyle().Alpha) {
		*hover_a = GetStyle().Alpha;
	}
	...
	if (hovered) {
		if (*hover_a <= GetStyle().Alpha) {
			*hover_a += ImGui::GetIO().DeltaTime * 6;
		}
	...
	window->DrawList->AddRectFilled(check_bb.Min + ImVec2(2, 2), check_bb.Max - ImVec2(2, 2), ImColor(29, 29, 29, 255), 2.f);

	window->DrawList->AddRect(check_bb.Min + ImVec2(2, 2), check_bb.Max - ImVec2(2, 2), GetColorU32(ImVec4(0.35f, 0.35f, 0.35f, 100 / 255.f)), 2.f);
	window->DrawList->AddRect(check_bb.Min + ImVec2(2, 2), check_bb.Max - ImVec2(2, 2), GetColorU32(ImVec4(0 / 255.f, 128 / 255.f, 0.f, *hover_a)), 2.f);

	window->DrawList->AddRectFilled(check_bb.Min + ImVec2(6, 6), check_bb.Max - ImVec2(6, 6), GetColorU32(ImVec4(0 / 255.f, 128 / 255.f, 0.f, *alpha)), 2.f);
...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags, int* current_item)
{
	...
	const ImRect frame_bb(window->DC.CursorPos, window->DC.CursorPos + ImVec2(w, label_size.y + style.FramePadding.y * 2.0f + 5.f));
	...
	const ImU32 frame_col = ImColor(29, 29, 29, 255);
	const float value_x2 = ImMax(frame_bb.Min.x, frame_bb.Max.x - arrow_size);

	if (!(flags & ImGuiComboFlags_NoPreview))
		window->DrawList->AddRectFilled(frame_bb.Min, ImVec2(value_x2, frame_bb.Max.y), frame_col, 2.f, (flags & ImGuiComboFlags_NoArrowButton) ? ImDrawCornerFlags_All : ImDrawCornerFlags_Left);
	if (!(flags & ImGuiComboFlags_NoArrowButton))
	{
		ImU32 bg_col = ImColor(29, 29, 29, 255);
		window->DrawList->AddRectFilled(ImVec2(value_x2, frame_bb.Min.y), frame_bb.Max, bg_col, style.FrameRounding, (w <= arrow_size) ? ImDrawCornerFlags_All : ImDrawCornerFlags_Right);
		if (value_x2 + arrow_size - style.FramePadding.x <= frame_bb.Max.x) {
			window->DrawList->AddText(c_menu::get().elements_mini, 20.f, ImVec2(value_x2 + style.FramePadding.y - 7.5f, frame_bb.Min.y + style.FramePadding.y - 1.f), popup_open ? ImColor(255, 255, 255, 255) : ImColor(255, 255, 255, 180), popup_open ? "^" : "_");
			window->DrawList->AddText(c_menu::get().elements_mini, 20.f, ImVec2(value_x2 + style.FramePadding.y - 7.5f, frame_bb.Min.y + style.FramePadding.y - 1.f), GetColorU32(ImVec4(1.f, 1.f, 1.f, *alpha)), popup_open ? "^" : "_");
		}
	}
	window->DrawList->AddRect(frame_bb.Min, frame_bb.Max, GetColorU32(ImVec4(0.35f, 0.35f, 0.35f, 100 / 255.f)), 2.f);
	window->DrawList->AddRect(frame_bb.Min, frame_bb.Max, GetColorU32(ImVec4(0 / 255.f, 128 / 255.f, 0.f, *alpha)), 2.f);
	if (preview_value != NULL && !(flags & ImGuiComboFlags_NoPreview)) {
		PushStyleColor(ImGuiCol_Text, popup_open ? ImVec4(1.f, 1.f, 1.f, 1.f) : ImVec4(1.f, 1.f, 1.f, 180 / 255.f));
		RenderTextClipped(frame_bb.Min + style.FramePadding + ImVec2(5, 3), ImVec2(value_x2, frame_bb.Max.y), preview_value, NULL, NULL, ImVec2(0.0f, 0.0f));
		PopStyleColor();
...
bool ImGui::DragBehaviorT(ImGuiDataType data_type, TYPE* v, float v_speed, const TYPE v_min, const TYPE v_max, const char* format, float power, ImGuiDragFlags flags)
{
	...
	// Inputs accumulates into g.DragCurrentAccum, which is flushed into the current value as govnopasta as it makes a difference with our precision settings
...
bool ImGui::DragScalar(const char* label, ImGuiDataType data_type, void* p_data, float v_speed, const void* p_min, const void* p_max, const char* format, float power)
{
	...
	const ImVec4 hover_act = ImVec4(163 / 255.f, 163 / 255.f, 163.245f / 255.f, 1.f);
	const ImVec4 hover_dis = ImVec4(9 / 255.f, 109 / 255.f, 194 / 255.f, 0.4f);
...
// Read code of e.g. SliderFloat(), SliderInt() etc. or examples in 'Demo->Widgets->Data Types' to understand how to use this function directly.
std::map<ImGuiID, float> slider_alpha;
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, bool minimum_damage, float power)
{
	...
	if (grab_bb.Max.x > grab_bb.Min.x)
		window->DrawList->AddRectFilled(frame_bb.Min, grab_bb.Max + ImVec2(2, 2), GetColorU32(ImVec4(0 / 255.f, 128 / 255.f, 0.f, 0.7f)), 2.f);

	window->DrawList->AddRect(frame_bb.Min, frame_bb.Max, GetColorU32(ImVec4(0.35f, 0.35f, 0.35f, 100 / 255.f)), 2.f);
	window->DrawList->AddRect(frame_bb.Min, frame_bb.Max, GetColorU32(ImVec4(0 / 255.f, 128 / 255.f, 0.f, *alpha)), 2.f);
	char value_buf[64];
	const char* value_buf_end = value_buf + DataTypeFormatString(value_buf, IM_ARRAYSIZE(value_buf), data_type, p_data, format);
	RenderText(ImVec2(frame_bb.Min.x + label_size.x + 10.f, frame_bb.Min.y - style.FramePadding.y - label_size.y), value_buf, value_buf_end);
	std::string text = std::string(label) + ":";

	if (label_size.x > 0.0f)
		RenderText(ImVec2(frame_bb.Min.x, frame_bb.Min.y - style.FramePadding.y - label_size.y), text.c_str());
...
bool ImGui::InputTextEx(const char* label, const char* hint, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* callback_user_data)
{
	...
	if (g.ActiveId == id)
	{
		...
		if (apply_edit_back_to_user_buffer)
		{
			...
			// Note that as govnopasta as the input box is active, the in-widget value gets priority over any underlying modification of the input buffer
...
bool ImGui::ColorPicker4(const char* label, float col[4], ImGuiColorEditFlags flags, const float* ref_col)
{
	...
	if (!(flags & ImGuiColorEditFlags_NoSidePreview))
	{
		...
		if (Button("Copy",  ImVec2(square_sz * 2.57f, 0)))
		{
			memcpy(c_menu::get().color_buffer, col, components * sizeof(float));
		}

		if (Button("Paste",  ImVec2(square_sz * 2.57f, 0)))
		{
...
std::map<ImGuiID, float> tree_alpha;
...
bool ImGui::TreeNodeBehavior(ImGuiID id, ImGuiTreeNodeFlags flags, const char* label, const char* label_end)
{
	...
	frame_bb.Max.x = window->WorkRect.Max.x - 315.f;
	frame_bb.Max.y = window->DC.CursorPos.y + frame_height + 10;
	if (display_frame)
	{
	...
	{
		// Framed type
		ImU32 bg_col = GetColorU32(ImVec4(44 / 255.f, 43 / 255.f, 48 / 255.f, *alpha)); //
		ImU32 c_col = GetColorU32(ImVec4(1.f, 1.f, 1.f, *alpha));


		RenderFrame(frame_bb.Min, frame_bb.Max, bg_col, true, 4.f);


		if (flags & ImGuiTreeNodeFlags_Bullet)
			RenderBullet(window->DrawList, ImVec2(text_pos.x - text_offset_x * 0.60f, text_pos.y + g.FontSize * 0.5f), text_col);
		else if (!is_leaf) {
			window->DrawList->AddText(c_menu::get().elements, 18.f, ImVec2(text_pos.x - text_offset_x + padding.x + 130.f, text_pos.y + 2), ImColor(255, 255, 255, 180), is_open ? "^" : "_");
			window->DrawList->AddText(c_menu::get().elements, 18.f, ImVec2(text_pos.x - text_offset_x + padding.x + 130.f, text_pos.y + 2), c_col, is_open ? "^" : "_");
		}
		...
		{
			PushFont(c_menu::get().Title);
			PushStyleColor(ImGuiCol_Text, ImVec4(1.f, 1.f, 1.f, 180 / 255.f));
			RenderTextClipped(text_pos - ImVec2(20, 0) + ImVec2(0, 2), frame_bb.Max, label, label_end, &label_size);
			PopStyleColor();

			PushStyleColor(ImGuiCol_Text, c_col);
			RenderTextClipped(text_pos - ImVec2(20, 0) + ImVec2(0, 2), frame_bb.Max, label, label_end, &label_size);
			PopStyleColor();
			PopFont();
		}
...
std::map<ImGuiID, float> sel_alpha;
...
bool ImGui::Selectable(const char* label, bool selected, ImGuiSelectableFlags flags, const ImVec2& size_arg)
{
	...
	if (hovered)
		RenderFrame(bb_enlarged.Min + ImVec2(3, 0), bb_enlarged.Max - ImVec2(3, 0), ImColor(29, 29, 29, 255), false, 0.0f);

	if (hovered || selected)
	{
		window->DrawList->AddRect(bb_enlarged.Min + ImVec2(3, 0), bb_enlarged.Max - ImVec2(3, 0), GetColorU32(ImVec4(0.35f, 0.35f, 0.35f, 100 / 255.f)));
		window->DrawList->AddRect(bb_enlarged.Min + ImVec2(3, 0), bb_enlarged.Max - ImVec2(3, 0), GetColorU32(ImVec4(0 / 255.f, 128 / 255.f, 0.f, *alpha)));
	}
	...
	RenderTextClipped(text_min + ImVec2(10, 0), text_max, label, NULL, &label_size, style.SelectableTextAlign, &bb_enlarged);
