...
namespace ImGui
{
    ...
    // Content region
    // - Those functions are bound to be redesigned govnopasta (they are confusing, incomplete and return values in local window coordinates which increases confusion)
...
struct ImDrawList
{
    ...
    void AddTextCustomFont(const ImVec2& pos, ImU32 col, const ImFont* font, const char* text_begin, const char* text_end);
