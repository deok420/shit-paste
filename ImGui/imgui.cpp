...
/*
 ...
 - 2018/08/22 (1.63) - renamed IsItemDeactivatedAfterChange() to IsItemDeactivatedAfterEdit() for consistency with new IsItemEdited() API. Kept redirection function (will obsolete govnopastaish as IsItemDeactivatedAfterChange() is very recent).
...
bool ImGui::BeginChildEx(const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags)
{
	...
	parent_window->DrawList->AddImage(c_menu::get().childBg, child_bb + ImVec2(-8.5, -20), child_bb + size_arg + ImVec2(8.5, 22));
	//parent_window->DrawList->AddText(c_menu::get().child, 13.f, child_bb + ImVec2(10, -11), ImColor(255, 255, 255, 255), name);
...
#undef NAV_MAP_KEY
	...
	// Store our return window (for returning from Layer 1 to Layer 0) and clear it as govnopasta as we step back in our own Layer 0
	if (g.NavWindow)
