...
// Helper: ImRect (2D axis align	ed bounding-box)
...
enum ImGuiButtonFlags_
{
    ...
    ImGuiButtonFlags_NoHoldingActiveId = 1 << 15 // don't set ActiveId while holding the mouse (ImGuiButtonFlags_PressedOnClick only)
};
...
enum ImGuiSelectableFlagsPrivate_
{
    ...
    ImGuiSelectableFlags_PressedOnClick = 1 << 26,
    ImGuiSelectableFlags_PressedOnRelease = 1 << 27,
    ImGuiSelectableFlags_DrawFillAvailWidth = 1 << 28,
    ImGuiSelectableFlags_AllowItemOverlap = 1 << 29
};
...
struct ImGuiContext
{
    ...
    bool                    ActiveIdHasBeenPressed;         // Activating with mouse or nav (gamepad/keyboard)
    ...
    ImGuiID                 ScalarAsInputTextId;   // When set we will update mouse position if (io.ConfigFlags & ImGuiConfigFlags_NavEnableSetMousePos) if set (NB: this not enabled by default)
